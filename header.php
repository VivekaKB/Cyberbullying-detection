...
font-size:16px;
  ...
  <div class="col-sm-4"><h2>Cyberbullying </h2></div>
   <div class="col-sm-8 tmenu">
   
  <a href="index.php" class="nav-btn" style="margin-left:20px;"> WELCOME <?php echo $_SESSION['email'] ?></a>
...
<br>
  ...
  <li>   <span class="glyphicon glyphicon-user"></span>  <a href="frd_request.php" class="nav-btn">Followers</a></li>
...
$row2 =mysqli_fetch_array($result2);
		...
		if($z>=2)
		{
			...
			Warning !!!!!!!! U have send Cyber bulling Data Count $z
